package com.example.arianitbalidemaj_quoteoftheday
...
import com.example.arianitbalidemaj_quoteoftheday.ui.theme.ArianitBalidemajQuoteOfTheDayTheme
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContent {
            ArianitBalidemajQuoteOfTheDayTheme {
